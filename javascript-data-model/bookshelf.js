...
console.log('author name of the 2nd book:', bookshelf[1].author);
console.log('isbn of the 1st book:', bookshelf[0].isbn);
console.log('title of the 3rd book:', bookshelf[2].title);
